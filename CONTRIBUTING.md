Contributing to GBTC Core
============================

The GBTC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GBTC Core project, and is not to be
confused with overall GBTC Network Protocol consensus changes.

Whether a pull request is merged into GBTC Core rests with the project merge
...
Patches that change GBTC consensus rules are considerably more involved than
...
Where a patch set proposes to change the GBTC consensus, it must have been
...
The project leader is the release manager for each GBTC Core release.
