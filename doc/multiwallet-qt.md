...
In order to support loading of multiple wallets in greenbitcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is greenbitcoin.cpp.
...
Changes to greenbitcoin.cpp
----------------------
greenbitcoin.cpp is the entry point into greenbitcoin-qt, and as such, will require some minor modifications to provide hooks for
